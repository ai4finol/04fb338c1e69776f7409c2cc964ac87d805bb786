...
<script type="text/javascript">
  ...
  function run(_rawData) {
    ...
    var dataset_BB = strategies_BB.map(function (strategy) {
      return {
        id: 'dataset_of_' + strategy,
        fromDatasetId: 'dataset_raw_BB',
        transform: {
          type: 'filter',
          config: {
            and: [
    ...
    var dataset_FTW = strategies_FTW.map(function (strategy) {
      return {
        id: 'dataset_of_' + strategy,
        fromDatasetId: 'dataset_raw_FTW',
        transform: {
          type: 'filter',
          config: {
            and: [
    ...
    var dataset_FTL = strategies_FTL.map(function (strategy) {
      return {
        id: 'dataset_of_' + strategy,
        fromDatasetId: 'dataset_raw_FTL',
        transform: {
          type: 'filter',
          config: {
            and: [
